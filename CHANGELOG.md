...
- **Color tokens**: `--color-data-*` tokens not resolved by `getComputedStyle` in light theme ([#104](https://github.com/dataintmx/dataint-ui/pull/104))
...
[Unreleased]: https://github.com/dataintmx/dataint-ui/compare/1.1.5...HEAD
[1.1.5]: https://github.com/dataintmx/dataint-ui/compare/1.1.4...1.1.5
